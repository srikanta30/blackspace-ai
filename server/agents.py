...
class BlackSpaceAI(Chain):
    ...
    def from_llm(cls, llm: ChatLiteLLM, verbose: bool = False, **kwargs) -> "BlackSpaceAI":
        """
        Class method to initialize the BlackSpaceAI Controller from a given ChatLiteLLM instance.
        ...
        ----------
        llm : ChatLiteLLM
            The ChatLiteLLM instance to initialize the BlackSpaceAI Controller from.
        ...
        -------
        BlackSpaceAI
            The initialized BlackSpaceAI Controller.
        """
